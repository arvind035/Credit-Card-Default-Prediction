...
def evaluate_model(model_list: list, X_train:np.ndarray, y_train:np.ndarray, X_test:np.ndarray, y_test:np.ndarray, base_accuracy:float=0.6) -> MetricInfoArtifact:
    """
...
class ModelFactory:
    ...
    def get_best_model(self, X, y,base_accuracy=0.0) -> BestModel:
        try:
