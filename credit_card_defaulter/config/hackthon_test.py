from credit_card_defaulter.entity.config_entity import DataIngestionConfig, TrainingPipelineConfig, DataValidationConfig,\
...
class Configuration:
    ...
    def get_data_ingestion_config(self,) -> DataIngestionConfig:
        '''
        This function for getting data ingestion config
        '''
        try:
            logging.info("This is checking of log")
            ...
            data_ingestion_config = DataIngestionConfig(dataset_url=dataset_url, tgz_dir=tgz_dir, raw_data_dir=raw_data_dir,
    ...
    def get_data_validation_config(self) -> DataIngestionConfig:
        '''
        This function for getting data validation config
        '''
        try:
            artifact_dir = self.training_pipeline_config.artifact_dir
            ...
            report_file_path = os.path.join(data_validation_artifact_dir, report_file_dir)
            report_page_file_path = os.path.join(data_validation_artifact_dir, report_file_page_dir)
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        '''
        This function for getting data transformation config
        '''
        try:
            artifact_dir = self.training_pipeline_config.artifact_dir
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        '''
        This function for getting model traning config
        '''
        try:
            artifact_dir = self.training_pipeline_config.artifact_dir
    ...
    def get_model_evaluation_config(self) ->ModelEvaluationConfig:
        '''
        This function for getting model evaluation config
        '''
        try:
    ...
    def get_model_pusher_config(self) -> ModelPusherConfig:
        '''
        This function for getting model config
        '''
        try:
